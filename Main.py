...
from MarkdownAsHTML import save_markdown_report
...
async def main():
  ...
  for query in initial_queries:
    print(f"- {query}")
  print("[bright_cyan] Conducting follow-up research")
  print()
  print(Panel("[bright_cyan] Web Search"))
  ...
  print("[green] Now scraping sources for required findings. P.S. This may take a few mins :)")
  ...
  markdown2 = Markdown(links)
  console.print(markdown2)

  save_markdown_report(final_synthesis+"""
